...
Open `clustering.ipynb` in Jupyter or VS Code and run all cells sequentially. Sections 1–4 run without any API key. Section 5 requires the OpenAI key.

## Project Structure

```
Customer Segmentation/
├── clustering.ipynb                  # Main notebook (115 cells)
├── README.md
└── dataset/
